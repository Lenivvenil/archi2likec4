"""Federation: template generators for federate.py script and registry."""


def generate_federate_script() -> str:
    """Generate adapted federate.py for the systems/ directory."""
    return '''\
#!/usr/bin/env python3
"""
...
def federate(filter_name=None):
    ...
    for project in projects:
        ...
        try:
            clone_or_pull(repo, local_path, branch)
